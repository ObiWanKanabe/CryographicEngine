...
void GameEngine::OnStart() {
	...
	ShaderManager::GetInstance()->StoreShader(std::string("shadowTest"), "../Shaders/shadowTest.vs", "../Shaders/shadowTest.fs");
	...
	Material *shadowTest = new Material(MATERIAL_TYPE::REFLECTIVE, ShaderManager::GetInstance()->GetShader(std::string("shadowTest")));
	...
	MaterialManager::GetInstance()->StoreMaterial(std::string("shadowTest"), shadowTest);
	...
	Mesh *shadowTestMesh = new Mesh(MESH_TYPE::CUBE, MaterialManager::GetInstance()->GetMaterial(std::string("shadowTest")));
	...
	MeshManager::GetInstance()->StoreMesh(std::string("shadowTest"), shadowTestMesh);
	...
	GameObject *shadowTestObject = new GameObject(std::string("shadowTest"), MeshManager::GetInstance()->GetMesh(std::string("shadowTest")));
	shadowTestObject->SetScale(glm::vec3(5.0f));
	shadowTestObject->SetPosition(glm::vec3(0.0f, 0.0f, 10.0f));
	...
	empty->AttachChild(shadowTestObject);
